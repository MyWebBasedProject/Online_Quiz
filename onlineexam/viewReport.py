...
def getViolationAndImage(message):
    ...
    if message == 'All':
        ...
        cursor.execute('SELECT * FROM temp_report where message = "Face Left Side" ')
    elif message == 'Face Right Side':
        cursor.execute('SELECT * FROM temp_report where message = "Face Right Side"')
    elif message == 'Looking Left':
        cursor.execute('SELECT * FROM temp_report where message = "Looking Left" ')
    elif message == 'Mobile Detected':
        cursor.execute('SELECT * FROM temp_report where message = "Looking Right" ')
    elif message == 'Multiple Person Detected':
        cursor.execute('SELECT * FROM temp_report where message = "Multiple Person Detected" ')
    elif message == 'No Face Detected':
        cursor.execute('SELECT * FROM temp_report where message = "No Face Detected" ')
    else:
        cursor.execute('SELECT * FROM temp_report where message = "Switched Application" ')
